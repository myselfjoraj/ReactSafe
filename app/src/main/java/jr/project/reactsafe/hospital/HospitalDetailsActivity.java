...
public class HospitalDetailsActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    void SetUpForDatabaseListening(String id){
        ...
        try (DatabaseHelper helper = new DatabaseHelper(HospitalDetailsActivity.this)){
            ...
            setAmbulance(model.getLATITUDE(),model.getLONGITUDE(),model.getAMBULANCE());
    ...
    void getAmbulance(String uid,String lat,String lng){
        FirebaseHelper.getEntity("ambulance", uid, model -> setAmbulance(lat,lng,model));
    }

    void setAmbulance(String lat,String lng,UserModel model){
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                lineOptions.color(ContextCompat.getColor(HospitalDetailsActivity.this,R.color.react_safe));
